...
export default function App() {
  ...
  if (user.role === "manager") return <GestorApp user={user} onLogout={() => setUser(null)} />;
  if (user.role === "driver") return <MotoristaApp user={user} onLogout={() => setUser(null)} />;
  if (user.role === "customer") return <CustomerApp user={user} onLogout={() => setUser(null)} />;
  return null;
}
