  ...
  const sections = [
    {
      ...
      content: 'Ao utilizar os nossos serviços, concorda com os presentes termos e condições. Estes termos aplicam-se a todos os serviços de entrega e transporte prestados pela J. RIBEIRO SERVIÇOS E.I. Reservamo-nos o direito de modificar estes termos a qualquer momento.'
    },
    {
      title: '2. Serviços',
      content: 'Oferecemos serviços de entrega rápida de documentos e encomendas, transporte de mercadorias e transporte de pessoas. Os detalhes específicos de cada serviço serão acordados no momento da solicitação. Não nos responsabilizamos por danos indiretos resultantes do uso dos nossos serviços.'
    },
    {
      title: '3. Responsabilidades do Cliente',
      content: 'O cliente deve fornecer informações precisas sobre o local de recolha e entrega. É responsabilidade do cliente garantir que a encomenda está devidamente embalada e não contém itens proibidos, como substâncias perigosas, ilegais ou perecíveis que não tenham sido declarados.'
    },
    {
      title: '4. Responsabilidades da Empresa',
      content: 'A J. RIBEIRO compromete-se a prestar serviços de qualidade com motoristas profissionais e veículos em boas condições. Não nos responsabilizamos por atrasos causados por condições de tráfego, condições meteorológicas adversas ou outras circunstâncias fora do nosso controlo.'
    },
    {
      title: '5. Pagamentos',
      content: 'Os preços são acordados no momento da solicitação do serviço. Aceitamos pagamento por dinheiro, transferência bancária, M-Pesa e cartão de crédito/débito. O pagamento deve ser efetuado conforme acordado no momento da contratação do serviço.'
    },
    {
      title: '6. Cancelamentos',
      content: 'Os pedidos de cancelamento devem ser feitos com pelo menos 2 horas de antecedência em relação à hora de recolha agendada. Cancelamentos fora deste prazo poderão incorrer em taxas de cancelamento de até 50% do valor do serviço.'
    },
    {
      title: '7. Propriedade Intelectual',
      content: 'Todo o conteúdo do nosso site e aplicação, incluindo logotipos, textos, imagens e design, é propriedade da J. RIBEIRO SERVIÇOS E.I e está protegido por leis de propriedade intelectual. Não é permitida a reprodução sem autorização expressa.'
    },
    {
      title: '8. Contacto',
      content: `Para questões relacionadas com estes termos e condições, entre em contacto connosco através do email ${appSettings.supportEmail || 'suporte@jrmultiservicos.co.mz'} ou pelo telefone ${appSettings.supportPhone || '+258 82 333 4455'}.`
    }
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-white text-xs sm:text-sm font-medium">Termos e Condições</span>
            </motion.div>
            ...
            >
              Conheça os nossos termos e condições de utilização dos serviços.
            </motion.p>
          </motion.div>
        </section>
