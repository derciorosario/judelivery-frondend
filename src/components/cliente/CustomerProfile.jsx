          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 disabled:opacity-50"
              >
                <Icon name="x" className={"text-black"} size={16} />
              </button>
            </div>
            ...
            <div className="px-4 py-3 border-t border-slate-100">
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={closeAddressMap}
                  className="flex-1 py-2 rounded-xl border border-slate-200 text-slate-600 disabled:opacity-50"
                >
                  Cancelar
                </button>
                <button
                  ...
                  className="flex-1 py-2 rounded-xl bg-green-500 text-white font-semibold disabled:opacity-50"
                >
                  Confirmar
                </button>
              </div>
